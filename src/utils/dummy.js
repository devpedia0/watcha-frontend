const dummy = {
  data: {
    ...
    items: [
      ...
      { rank: 7, imgSrc: process.env.PUBLIC_URL + '/images/1.jpg' },
      { rank: 8, imgSrc: process.env.PUBLIC_URL + '/images/2.jpg' },
      { rank: 9, imgSrc: process.env.PUBLIC_URL + '/images/3.jpg' },
      { rank: 10, imgSrc: process.env.PUBLIC_URL + '/images/4.jpg' },
      { rank: 11, imgSrc: process.env.PUBLIC_URL + '/images/5.jpg' },
