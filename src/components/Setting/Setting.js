          ...
          <ChildrenContainer>
            <div>
              <div className="containerMargin">
                ...
                <Section>
                  <div className="subCategoryTitle">SNS 연동 설정</div>
                  <VisualUl Padding>
                    <TextList>
                      <div className="inner">
                ...
                <Section>
                  ...
                  <VisualUl Padding>
                    <TextList Pointer>
                      <div className="inner">
                        <div className="innerTitle">페이스북 친구 추가</div>
                      </div>
                    </TextList>
                  </VisualUl>
                </Section>
                  ...
                  <VisualUl Padding>
                    ...
                    <TextList>
                      <div className="inner" onClick={() => setLang(!lang)}>
                        ...
                        <div className="extra">
                          <span className="languageValue">{nation}</span>
                        </div>
                      </div>
                    </TextList>
                  </VisualUl>
                ...
                <Section>
                  ...
                  <VisualUl Padding>
                    <TextList Pointer>
                      <div className="inner">
                        <div className="innerTitle">문의하기 / FAQ</div>
                      </div>
                    </TextList>
                    <TextList Pointer>
                      <div className="inner">
                        <div className="innerTitle">DB 수정/추가 요청하기</div>
                      </div>
                    </TextList>
                  </VisualUl>
                </Section>
