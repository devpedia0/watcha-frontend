...
export const CONTENT_INTEREST_DELETE = "content/CONTENT_INTEREST_DELETE";
...
export const CONTENT_FETCH_COMMENT = "content/CONTENT_FETCH_COMMENT";
export const CONTENT_FETCH_COLLECTION = "content/CONTENT_FETCH_COLLECTION";
