...
export default function SignUp(props) {
  ...
  const signUpState = (type, value) => {
    if (!value) {
      return 'label';
    }
    return signUpValidate(type) ? 'label' : 'labelWrong';
  };
            ...
            <div>
              <div>
                <Content>
                  <Form>
                    <div className="area">
                      <NameIdPw className={signUpState('name', props.name)}>
                        <input
                          ...
                          autoComplete="off"
                          type="text"
                          className={props.name ? 'check' : 'none'}
                        />
                    ...
                    <div className="area">
                      <NameIdPw className={signUpState('email', props.email)}>
                        <input
                          value={props.email}
                          ...
                          autoComplete="off"
                          type="email"
                          className={props.email ? 'check' : 'none'}
                        />
                        {/* <div className="delBtn">
                          <span className="delIcon" />
                        </div> */}
                    ...
                    <div className="area">
                      <NameIdPw
                        className={signUpState('password', props.password)}>
                        <input
                          ...
                          autoComplete="off"
                          type="password"
                          className={props.password ? 'check' : 'none'}
                        />
                        {/* <div className="delBtn">
                          <span className="delIcon" />
                        </div> */}
                    ...
                    <SignUpBtn type="button" onClick={props.handleSignUp}>
                      회원가입
                    </SignUpBtn>
                  </Form>
                  <AlReady>
