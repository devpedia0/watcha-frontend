...
const Login = (props) => {
  const loginValidate = props.email.includes('@') && props.password.length > 5;
                ...
                <Content>
                  <form>
                    <Area>
                      <IdPw>
                        <Value
                          className={props.loginState('email', props.email)}>
                          <Input
