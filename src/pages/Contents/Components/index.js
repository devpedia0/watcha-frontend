export { default as ContentsHeader } from "./ContentsHeader/ContentsHeader";
export { default as ContentsHeaderInfo } from "./ContentsHeaderInfo/ContentsHeaderInfo";
...
export { default as ContentsPoster } from "./ContentsPoster/ContentsPoster";

export { default as ModalComment } from "./Modals/ModalComment";
export { default as ModalInterest } from "./Modals/ModalInterest";
export { default as ModalNeedLogin } from "./Modals/ModalNeedLogin";
