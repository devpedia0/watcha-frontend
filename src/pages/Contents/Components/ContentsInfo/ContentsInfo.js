...
const ContentsInfo = ({ data, onOpenModal }) => {
    const {
    ...
    return (
        <Wrapper>
            <div className="infoList">
                ...
                <ButtonContainer>
                    <ButtonBlock
                        isClicked={context ? !!context.interestState : false}
                        onClick={() => onOpenModal("interest")}
                    >
                        <button className="btn-left">
                            <div className="btn-left-content">
                                <IconSelector status={context?.interestState} />

                                <div className="text">
                                    {context?.interestState === "WATCHING"
                                        ? "보는중"
                                        : "보고싶어요"}
                                </div>
                            </div>
