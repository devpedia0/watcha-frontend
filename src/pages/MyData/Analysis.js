              ...
              <div className="header">
                <Margin>
                  ...
                  <h1 className="analysisTitle">
                    <span className="analysisWord">취향분석</span>
                    <div className="roundedImage">
                      <div className="profileImage"></div>
                    </div>
                    <div className="userName" onClick={checkState}>
                      {userInfo.userName}
                    </div>
                  </h1>
                </Margin>
                ...
                <div>
                  <Margin>
                    <header className="ratingHeader">
                      <h2 className="ratingTitle">평가수</h2>
                    </header>
                  </Margin>
                </div>
                <div>
                ...
                <div>
                  <Margin>
                    <div className="starHeader">
                      <h2 className="starTitle">별점 분포</h2>
                    </div>
                  </Margin>
                </div>
                <div>
            ...
            <Favorite>
                ...
                <div>
                  <Margin>
                    <header className="tagHeader">
                      <h2 className="tagTitle">영화 선호태그</h2>
                    </header>
                  </Margin>
                </div>
                <div>
              ...
              <section className="favoriteBox">
                <div>
                  <Margin>
                    <header className="tagHeader">
                      <h2 className="tagTitle">영호 선호장르</h2>
                    </header>
                  </Margin>
                </div>
                <div>
              ...
              <section className="totalRunning">
                <div>
                  <Margin>
                    <header className="tagHeader">
                      <h2 className="tagTitle">영화 감상 시간</h2>
                    </header>
                  </Margin>
                </div>
                <div>
